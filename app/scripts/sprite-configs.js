...
(function (GAME) {
    ...
    var SpriteConfigs = (function () {
        ...
        SpriteConfigs.asteroidLargeSpriteInfo = new SpriteInfo("images/gameart/asteroid_blue.png", 90, 90, 40);
        SpriteConfigs.asteroidMediumSpriteInfo = new SpriteInfo("images/gameart/asteroid_blue_medium.png", 68, 68, 30);
        SpriteConfigs.asteroidSmallSpriteInfo = new SpriteInfo("images/gameart/asteroid_blue_small.png", 45, 45, 20);
